(function () {
    ...
    var ExtendedModel = Backbone.Model.extend({
        ...
        _origSave: Backbone.Model.prototype.save,
        _baseSave: function (key, val, options) {
        ...
        save: function (key, val, options) { this._save(key, val, options); }
    });
    window.Backbone.Model = ExtendedModel;
    ...
    window.Backbone.View = ExtendedView;
    ...
    window.Backbone.Collection = ExtendedCollection;
